...
import { Card, CardBody, Input, Button, Chip, Image } from "@nextui-org/react";
          ...
          <div className="flex items-center space-x-4">
            {editing ? (
              <div className="w-24 h-24 bg-white/20 rounded-xl flex flex-col items-center justify-center p-2 text-center">
                ...
                />
                {newCoverImage && (
                  <span className="text-xs mt-1 truncate w-full block">
                    {newCoverImage.name}
                  </span>
                )}
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-1">
                ...
                <span className="text-sm">{course.enrolled_students?.length || 0} Students</span>
              </div>
            </div>
          </div>

          {/* ===== Right side: Edit/Save/Cancel/Publish ===== */}
